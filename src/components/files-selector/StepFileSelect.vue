...
<template>
  <div class="file-select">
    <div class="file-select__top border-bottom">
      <base-header mainText="Choose Photos Source" @close="closePlugin" />
    </div>

    <div class="file-select__medium">
      <ul class="file-select__list">
        <li class="file-select__item">
          <label class="file-select__card" id="menu_choose_album">
            <input
              type="file"
              class="hide-input"
              accept="image/*"
        ...
        <li class="file-select__item" v-if="isMobile">
          <label class="file-select__card" id="menu_take_photo">
            <input
              type="file"
              class="hide-input"
              accept="image/*"
      ...
      <ul class="file-select__list">
        <li class="file-select__item">
          <label class="file-select__card" id="menu_third_way" @click="handleOpenFilestack">
  ...
  setup(props, context) {
    ...
    function handleOpenFilestack() {
      ...
      const options = {
        ...
        onOpen: function (res) {
          setTimeout(() => {
            const menu = document.getElementsByClassName("fsp-mobile-menu");
            menu[0].click();
          }, 300);
        },
